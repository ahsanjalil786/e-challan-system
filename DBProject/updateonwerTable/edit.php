...
// 4th number pay yaha pay car_category ki jaga table name likho
 $update = "UPDATE onwer SET  first_name='$b'  , last_name='$c' ,address='$d'  where Onwer_CNIC='$a' ";
...
<form method="post">
<h1>Update Record</h1>
<input type="text" name="a" placeholder="onwer_CNIC'" value="<?php echo $row['Onwer_CNIC']; ?>"><br>
<input type="text"  name="b" placeholder="first_name" value="<?php echo $row['first_name']; ?>"><br>
<input type="text"  name="c" placeholder="last_name" value="<?php echo $row['last_name']; ?>"><br>
<input type="text" name="d" placeholder="email" value="<?php echo $row['address']; ?>"><br>
